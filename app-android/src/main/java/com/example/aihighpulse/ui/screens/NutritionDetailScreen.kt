    ...
    BrandScreen(Modifier.fillMaxSize()) {
        Column(
            ...
            Row(
                ...
                Text(
                    stringResource(R.string.nutrition_detail_title),
            ...
            when (ui) {
                ...
                is UiState.Data -> {
                    ...
                    if (meal == null) {
                        Text(stringResource(R.string.nutrition_detail_missing), color = Color.White)
                    } else {
                        AnimatedVisibility(
                            visible = true,
                            ...
                            Card(
                                ...
                                Column(
                                    ...
                                    Text(
                                        stringResource(R.string.nutrition_macros_detail, meal.macros.proteinGrams, meal.macros.fatGrams, meal.macros.carbsGrams),
                                        color = Color(0xFF3A3A3A)
                                    )
                                    Text(
                                        stringResource(R.string.nutrition_ingredients),
